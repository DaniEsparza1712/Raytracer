...
public class Camera extends Object3D{
    ...
    private double nearPane;
    private  double farPane;

    public Camera(Vector3D position, double fieldOfViewHorizontal, double fieldOfViewVertical, int widthResolution, int heightResolution, double nearPane, double farPane) {
    ...
    public double getNearPane() {
        return nearPane;
    }

    public void setNearPane(double nearPane) {
        this.nearPane = nearPane;
    }

    public double getFarPane() {
        return farPane;
    }

    public void setFarPane(double farPane) {
